...
def detect_balls(crop=None, frame=None):
    ...
    if frame is None:
        ...
        crop_area = crop if crop is not None else (0, 0, 3280, 480)
...
if __name__ == "__main__":
    def run_ball_detection_test():
        print("カメラからボールを探します...")
        processed_frame, balls = detect_balls()
        for ball in balls:
            print(f"見つけたボール - 色: {ball['color']}, 重心: X={ball['cx']}, Y={ball['cy']}, 半径: {ball['radius']}")
