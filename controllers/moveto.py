...
class MoveOmni():
    ...
    def movexy(self, x, y, speed=0.5):
        ...
        pulses_a =  wheel_rotation_x - wheel_rotation_y
        pulses_b =  wheel_rotation_x + wheel_rotation_y
        pulses_c = -wheel_rotation_x - wheel_rotation_y
        pulses_d = -wheel_rotation_x - wheel_rotation_y
